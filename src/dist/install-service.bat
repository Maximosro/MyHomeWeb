@echo off
:: =====================================================================
::  install-service.bat — Registra MyHomeWeb como servicio
::  en segundo plano que se inicia automaticamente con Windows 11.
...
echo ========================================
echo  MyHomeWeb — Instalador de Servicio
echo ========================================
echo.
...
set "TEMP_XML=%TEMP%\mhw_task.xml"
