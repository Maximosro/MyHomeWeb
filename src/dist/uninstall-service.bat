@echo off
:: =====================================================================
::  uninstall-service.bat — Elimina el servicio MyHomeWeb
...
echo ========================================
echo  MyHomeWeb — Desinstalador de Servicio
echo ========================================
echo.
...
:: 2. Matar todos los procesos en el puerto 8080
...
echo  Tus datos en data\myhomeweb.db NO se han eliminado.
echo ========================================
echo.
pause
